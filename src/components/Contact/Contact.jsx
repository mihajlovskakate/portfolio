                ...
                <div className="row">
                    <div className="col details">
                        <div className="contact-intro">
                            ...
                            <p>Are you also passonate about NLP or using technology in your classroom? Contact me, and we can talk about Computational Linguistics, Computer-Assessed Language Learning or different trends in Education Technology!</p>
